...
# Raw data manipulation and design matrix.
## Packages.
...
```
## Extract male subjects, aged 50-59, from ventilator Case (All cases on a ventilator 
...
## Annotate genes with Entrez Gene identifiers and RefSeq for GO and KEGG enrichment.
# Get Entrez ID.
...
## Convert the final counts to DGEList.
...
## Data exploration: examine outliers and sample relationships.
...
# Differential analysis of any pairs with analysis of deviance (ANODEV). In the 
...
# Differential analysis of any pairs with glmLRT() via a loop.

## Extract DEGs in each comparison.
...
## Extract tissue specific DEGs from above data frames.
...
## Extract DEGs identified by both methods.
...
# Summary of DEGs by the two methods and the overlapping DEGs.
