...
## 1.5 Annotate genes with Entrez Gene identifiers and RefSeq for GO and KEGG enrichment.
...
## 1.6 Convert the final counts to DGEList.
...
## 1.7 Data exploration: examine outliers and sample relationships.
